...
def displayCandle(data,COMPANY):
        ...
        chart_small = data[-diplayTradingDays:] #set number of days to display
        ...
        #Draw green candles based on seperated data, change drawing color to green.

        #Red Candles
        plt.bar(x=red_df["Date"], height=red_df["Height"], bottom=red_df["Close"], color="Red")
        #Draw green candles based on seperated data, change drawing color to red. Uses close instead of open as it is opposite direction on chart.
